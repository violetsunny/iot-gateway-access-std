...
@Component
@Slf4j
public class DeviceCache extends CafCache<String, Map<String, Object>> {

    /**
     * 缓存过期时间，分钟
     */
    @Value("${ennew.caffeine.device.duration:60}")
    private Long duration;
    /**
     * 缓存初始容量
     */
    @Value("${ennew.caffeine.device.initialCapacity:1000}")
    private Integer initialCapacity;
    /**
     * 缓存最大容量
     */
    @Value("${ennew.caffeine.device.maximumSize:10000}")
